...
#define ROUTINE_FILLFACE            2
#define ROUTINE_GUESSIFFACEISVISIBE 3
#define ROUTINE_SORTPOINTS          4
#define ROUTINE_FILL8               5
#define ROUTINE_PREPAREBRESRUN      6
#define ROUTINE_BRESRUNTYPE1        7
#define ROUTINE_BRESRUNTYPE2        8
#define ROUTINE_BRESRUNTYPE3        9
#define ROUTINE_HFILL               10
#define ROUTINE_HZFILL              11
#define ROUTINE_GLDRAWSEGMENTS		12
#define ROUTINE_GLDRAWPARTICULES	13
#define ROUTINE_GLPROJECTARRAYS		14
#define ROUTINE_INITSCREENBUFFERS	16
#define ROUTINE_BUFFER2SCREEN       17
#define ROUTINE_KEYEVENT            18
#define PROFILER_ROUTINE_COUNT   	19	
...
FUNCTIONNAME(ROUTINE_GLDRAWPARTICULES,"glDrawParticules")
