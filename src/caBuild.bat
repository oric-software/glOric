...
ca65 -t%PLATFORM% glProjectPoint.asm -g -l glProjectPoint.lst -o glProjectPoint.o  --include-dir .
...
ar65 r glOric.lib camera.o temp.o fill8.o zbuff.o hzfill.o projection.o  glProjectPoint.o scene.o glOric_c.o
